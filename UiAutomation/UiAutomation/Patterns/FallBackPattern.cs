...
internal class FallBackPattern(IUIAutomation automation, IUIAutomationElement element) : IPattern
{
    ...
    {
        returnValue = FirstControlUnder(element, automation.RawViewWalker, UIA_ControlTypeIds.UIA_TextControlTypeId)?.CurrentName;
        if (string.IsNullOrEmpty(returnValue))
        {
            returnValue = element.CurrentName;
        }
    ...
    private bool DoesApply() => element.CurrentIsKeyboardFocusable != 0;
