...
internal class SelectionPattern(IUIAutomation automation, IUIAutomationElement element) : IPattern
{
    private const string Delimiter = ";";

    private readonly IUIAutomationSelectionPattern _selectionPattern = element.GetCurrentPattern(UIA_PatternIds.UIA_SelectionPatternId) as
    ...
    public SetResult TrySet(string value)
    {
        ...
        element.ExpandAll(automation, 0);
        ...
        var condition = automation.CreatePropertyCondition(UIA_PropertyIds.UIA_NamePropertyId, value);
        var item = element.FindFirst(TreeScope.TreeScope_Descendants, condition);
        return item == null
            ? SetResult.Failure
