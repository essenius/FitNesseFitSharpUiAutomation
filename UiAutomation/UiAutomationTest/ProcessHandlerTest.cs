...
public class ProcessHandlerTest
{
    ...
    public void ProcessHandlerDiagnosticsTest()
    {
        ...
        for (var i = 0; i < elements.Length; i++)
        {
            ...
            Debug.Print(
                $"{element.CurrentClassName};{element.CurrentName};{element.CurrentProcessId};" +
                $"{element.CurrentFrameworkId};{element.CurrentNativeWindowHandle}"
            );
        }
        ...
        for (var i = 0; i < frameElements.Length; i++)
        {
            ...
            for (var j = 0; j < subElements.Length; j++)
            {
                ...
                Debug.Print(
                    $"{subElement.CurrentClassName};{subElement.CurrentName};{subElement.CurrentProcessId};" +
    ...
    public void ProcessHandlerTest1() => _ = new ProcessHandler("id:1");
}
