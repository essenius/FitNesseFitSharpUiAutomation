...
namespace UiAutomationTest
{
    ...
    public class ScreenCaptureTest
    {
        ...
        public void ScreenCaptureTakeTest()
        {
            ...
            Assert.IsTrue(image.ToString().StartsWith("Image"));
            Assert.IsTrue(image.ToString().EndsWith("(2 x 1)"));
            ...
            Assert.IsTrue(screenshot.ToString().StartsWith("Image"), "Starts With Image");
            ...
            Assert.IsTrue(screenshotRendering.StartsWith("<img src='data:image/jpeg;base64,"));
        }
    }
}